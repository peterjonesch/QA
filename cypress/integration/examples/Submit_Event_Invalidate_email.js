...
describe('Test email validation', () => {
    ...
    it('No id,only domain', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_1);

    })
    it('Only id,no domain', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_2);

    })

    it('Incorrect domain', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_3);

    })
    it('consecutive dots', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_4);

    })

    it('User id and @ and no domain after that', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_5);

    })

    it('multiple domains', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_6);

    })
    it('garbage mail', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_7);

    })

    it('ip domain', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_8);

    })
    it('uni characters', () => {
        // fill in email
        cy.get('input[data-cy="your-email"]').type(testData.email_9);
